...
const char* LibBuildVersion_Firebird = "Firebird 1.0.x (2008-09-xx)";
...
// declare entry point
extern "C" void __firebird_main(void) __attribute__((noreturn));

// define entry point
extern "C" void __firebird_main(void)
{
